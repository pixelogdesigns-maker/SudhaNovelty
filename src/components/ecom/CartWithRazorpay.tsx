              ...
              <div className="w-full space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-md hover:shadow-lg"
                  >
                    {showRazorpay ? 'Hide Razorpay' : 'Pay with Razorpay'}
                  </button>
                </div>

                {/* Razorpay Checkout Component */}
                {showRazorpay && (
                  <CartTotalsTotal asChild>
                    {({ total }) => (
                      <RazorpayCheckout
                        amount={total || 0}
                        productName="Sudha Novelties Order"
                        productDescription="Complete order from Sudha Novelties"
