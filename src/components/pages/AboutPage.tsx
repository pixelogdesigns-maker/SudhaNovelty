...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative w-full bg-gradient-to-br from-light-pink to-white py-24">
        <div className="max-w-[120rem] mx-auto px-6">
          ...
          >
            <h1 className="font-heading text-5xl md:text-7xl text-primary mb-8">
              Our Story
            </h1>
            <p className="font-paragraph text-xl md:text-2xl text-foreground leading-relaxed text-gray-600">
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        {/* Decorative Blob */}
        <div className="absolute top-1/2 right-0 -translate-y-1/2 w-96 h-96 bg-light-pink/30 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="max-w-[120rem] mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="font-heading text-4xl md:text-6xl text-primary mb-8 leading-tight">
                A Decade of <br/><span className="text-secondary">Pure Joy</span>
              </h2>
              <div className="space-y-6 font-paragraph text-lg text-gray-600 leading-relaxed">
                <p>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="rounded-[3rem] overflow-hidden shadow-2xl border border-gray-100 transform hover:scale-[1.02] transition-transform duration-500">
                <Image
      ...
      <section className="py-24 bg-primary text-white">
        <div className="max-w-[120rem] mx-auto px-6">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-white/90 mb-16 max-w-3xl mx-auto leading-relaxed">
